...
import org.azora.studio.editor.StudioAction
import org.azora.studio.editor.StudioFloatingWindowsProvider
import org.azora.studio.editor.StudioScreen
...
fun StudioAppWithStateExport(
    ...
    screenOffsetX: Float = 0f,
    screenOffsetY: Float = 0f,
    onDockStateChanged: (org.azora.sdk.docking.domain.DockState, (DockAction) -> Unit) -> Unit,
